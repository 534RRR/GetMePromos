    ...
    <div className="container" style={{ padding: '2rem 1.5rem 5rem 1.5rem', maxWidth: '880px' }}>
      ...
      >
        ...
        <section>
          ...
          <p>
            To initiate an automated data deletion request, you can submit an erasure request to our privacy endpoint at <code>/api/privacy/delete-data</code> with your registered email, or email our Data Protection Desk directly at <a href="mailto:privacy@grabyourdealz.com" style={{ color: 'var(--primary)', fontWeight: 700 }}>privacy@grabyourdealz.com</a>. Requests are processed within 48 hours.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <br />
            <strong style={{ color: 'var(--text-heading)' }}>Email:</strong> <a href="mailto:privacy@grabyourdealz.com" style={{ color: 'var(--primary)', fontWeight: 700 }}>privacy@grabyourdealz.com</a>
          </p>
        </section>
      </div>
    </div>
