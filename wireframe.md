# RefPromos.com — UI/UX Wireframe & Layout Specification

> **Document Version:** 1.0  
> **Source:** RefPromos Wireframe Sheet (Main Pages)  
...
```
┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
│ [LOGO] RefPromos    Coupons   Deals   Stores   Categories   Blogs   Reviews    [🔍] [🇺🇸 US ▾] [🤍]│
└──────────────────────────────────────────────────────────────────────────────────────────────────┘
```

### Component Breakdown
* **Left:** Brand Logo (RefPromos with vector icon).
...
*This document is stored in `wireframe.md` and provides the exact UI/UX structure for RefPromos.com.*
