# GrabYourDealz.com — Multi-Region Coupon & Deals Platform
...
| `NEXT_PUBLIC_SITE_URL` | Client & Server | Public canonical domain URL of the website | `"https://grabyourdealz.com"` |
